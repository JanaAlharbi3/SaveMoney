...
public class transfers2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_transfers2);
        ...
        try {
            ...
            DataBaseHelper dataBaseHelper = new DataBaseHelper(transfers2.this);
            List<model> everyone=dataBaseHelper.transfer2();
