...
public class monthly_r_p extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_monthly_rp);
        ...
        try {
            ...
            DataBaseHelper dataBaseHelper = new DataBaseHelper(monthly_r_p.this);
            List<model> everyone=dataBaseHelper.m();
